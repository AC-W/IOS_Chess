...
export default function App() {
  ...
  const [game_ID,set_game_ID] = useState("test_game_ID")
  const [new_user_ID,set_user_ID] = useState(uuid.v4())
  ...
  function join_game(color){
    ...
    formData.append('gameID',game_ID);
    formData.append('userId',new_user_ID);
    ...
    <View style={styles.container}>
      <View style={styles.userInfo}>
        ...
        <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
          ...
          <Button title='create account' onPress={create_account}></Button>
        </View>
        <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
          <Button title='Join Game Room' onPress={Pre_Join}></Button>
          <Button title='Generate Room ID' onPress={()=>{set_game_ID(uuid.v4())}}></Button>  
        </View>
        <Text>Room ID: {game_ID}</Text>
